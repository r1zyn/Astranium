        ...
        await member.kick(reason ?? undefined).then(async (): Promise<void> => {
            if (!member.user.bot) {
                    ...
                    .then(
                        async (
                            ...
                            await interaction.reply({
                                embeds: [
                                    client.util.embed({
                                        description: `${Constants.Emojis.white_check_mark} Successfully kicked ${member} from the server (**ID ${moderationCase.caseId}**)`
                                    })
                                ],
                                ephemeral: true
                            });
                ...
                await interaction.reply({
                    embeds: [
                        client.util.embed({
                            description: `${Constants.Emojis.white_check_mark} Successfully kicked ${member} from the server.`
                        })
                    ],
                    ephemeral: true
                });
